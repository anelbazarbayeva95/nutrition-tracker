...
fun SettingsScreen(
    ...
    LaunchedEffect(savedSettings) {
        ...
        isEditMode = name.isEmpty() && age.isEmpty() && gender.isEmpty()
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            HeaderSection(title = "Settings", showSettings = false, showBackButton = true, onBackClick = onBackClick)
            ...
            if (isEditMode) {
                Column(
                    ...
                    PersonalInformationSection(name = name, onNameChange = { name = it }, age = age, onAgeChange = { age = it }, gender = gender, onGenderChange = { gender = it })
                    PhysicalDetailsSection(height = height, onHeightChange = { height = it }, weight = weight, onWeightChange = { weight = it }, bodyFat = bodyFat, onBodyFatChange = { bodyFat = it }, activityLevel = activityLevel, onActivityLevelChange = { activityLevel = it })
                    Spacer(modifier = Modifier.height(8.dp))
                    Button(
                        onClick = { viewModel.saveSettings(SettingsData(name = name, age = age, gender = gender, height = height, weight = weight, bodyFat = bodyFat, activityLevel = activityLevel)) },
                ...
                Column(
                    ...
                    SettingsSummaryView(name = name, age = age, gender = gender, height = height, weight = weight, bodyFat = bodyFat, activityLevel = activityLevel)
                    Spacer(modifier = Modifier.height(8.dp))
                    Button(
                        onClick = {
                        ...
                        Text("Personalized RDI Calculator", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                    }
                    ...
                    Button(
                        ...
                        Text("Customize Settings", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                    }
                    Spacer(modifier = Modifier.height(16.dp))
                }
            }
...
@Composable
fun ExpandableSection(title: String, expanded: Boolean, onExpandToggle: () -> Unit, content: @Composable () -> Unit) {
    Card(
        ...
        Column {
            Row(
                ...
                Icon(imageVector = Icons.Default.ArrowDropDown, contentDescription = if (expanded) "Collapse" else "Expand", tint = MaterialTheme.colorScheme.primary)
            }
...
@Composable
fun SettingsSummaryView(name: String, age: String, gender: String, height: String, weight: String, bodyFat: String, activityLevel: String) {
